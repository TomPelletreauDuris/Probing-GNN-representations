...
# import the model
from models.models_BA_2grid_house import GIN_framework4_dropout as framework
# import the dataset
...
train_features1 = pad_features(train_features, max_length)
test_features1 = pad_features(test_features, max_length)

# Check the shape of each feature
for i, feat in enumerate(train_features1):
    print(f"Train feature {i} shape: {[f.shape for f in feat]}")

for i, feat in enumerate(test_features1):
    print(f"Test feature {i} shape: {[f.shape for f in feat]}")
