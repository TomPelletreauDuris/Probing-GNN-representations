...
def read_dataset_MDD():
    """
    read data from Dataset/MDD.mat' and reconstruct data as 'torch_geometric.data.Data'
    """
    
    data = scio.loadmat('Datasets/FC/MDD.mat')   # Data is available at google drive (https://drive.google.com/drive/folders/1EkvBOoXF0MB2Kva9l4GQbuWX25Yp81a8?usp=sharing).
    dataset = []
    for graph_index in range(len(data['label'])):
        label = data['label']
